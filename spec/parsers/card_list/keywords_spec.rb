...
RSpec.describe Parsers::CardList::Keywords do
  ...
  describe ".load_cache" do
    ...
    it { is_expected.to be_a Parsers::CardList::Keywords }
  ...
  describe "#each" do
    ...
    it "returns each card as a Keyword" do
      expect(parser).to all(be_a OpenSWU::Data::Keyword)
    end
  end
end
