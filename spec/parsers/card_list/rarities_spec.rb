...
RSpec.describe Parsers::CardList::Rarities do
  ...
  describe ".load_cache" do
    ...
    it { is_expected.to be_a Parsers::CardList::Rarities }
  ...
  describe "#each" do
    ...
    it "returns each card as a Rarity" do
      expect(parser).to all(be_a OpenSWU::Data::Rarity)
    end
  end
end
