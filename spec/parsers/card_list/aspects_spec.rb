...
RSpec.describe Parsers::CardList::Aspects do
  ...
  describe ".load_cache" do
    ...
    it { is_expected.to be_a Parsers::CardList::Aspects }
  ...
  describe "#each" do
    ...
    it "returns each card as a Aspect" do
      expect(parser).to all(be_a OpenSWU::Data::Aspect)
    end
  end
end
